...
* ### Wavelet Transformation
  ...
  ![Filter Bank Scheme for DWT](https://github.com/SunHao95/PHBS_TQFML-Stock-Index-Prediction-Based-on-Wavelet-Transformation-ARIMA-ML-Model/blob/master/images/1.png)
